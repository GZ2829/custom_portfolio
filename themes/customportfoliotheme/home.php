...
<head>
    ...
    <link href="<?= get_template_directory_uri()?>'/assets/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="<?= get_template_directory_uri()?>'/assets/lib/lightbox/css/lightbox.min.css" rel="stylesheet">
...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <script src="<?= get_template_directory_uri()?>/assets/lib/typed/typed.min.js"></script>
    <script src="<?= get_template_directory_uri()?>/assets/lib/easing/easing.min.js"></script>
    <script src="<?= get_template_directory_uri()?>/assets/lib/waypoints/waypoints.min.js"></script>
    <script src="<?= get_template_directory_uri()?>/assets/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="<?= get_template_directory_uri()?>/assets/lib/isotope/isotope.pkgd.min.js"></script>
    <script src="<?= get_template_directory_uri()?>/assets/lib/lightbox/js/lightbox.min.js"></script>
